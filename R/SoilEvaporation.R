...
SoilEvaporation <- function(ClockStruct, Soil, Crop, IrrMngt, FieldMngt, 
      ...
      if ((ClockStruct$TimeStepCounter == 1) | ((NewCond$DAP == 1)) &
          ...
          Wevap <- EvapLayerWaterContent(NewCond,Soil,Wevap)
      ...
      if(ToExtract > 0){
          ...
          for(jj in 1:ClockStruct$EvapTimeSteps){
